 ...
 * @date 2018/10/25
 */
public class ConverterBeanDefinition {
    ...
    public ConverterBeanDefinition(String beanName, String beanClassName, Class<?> sourceClass, Class<?> targetClass) {
    ...
    public boolean equals(Object o) {
        ...
        ConverterBeanDefinition that = (ConverterBeanDefinition) o;
